...
test('"new Date()" is yyyy-MM-dd style.', () => {
  expect(new Date().formate('yyyy-MM-dd').length).toBe(10);
});

test('"new Date()" is yyyy-MM-dd hh:mm:ss style.', () => {
  expect(new Date().formate('yyyy-MM-dd hh:mm:ss').length).toBe(19);
});
